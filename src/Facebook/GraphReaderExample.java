...
public class GraphReaderExample {
  ...
  public static void main(String[] args) {
    new GraphReaderExample("CAACEdEose0cBAFPdHGhcQ4Tx1iZCz78bBjuzaEGsG07qKlBjyn9WXfroOdJSqhgmgIBIt3iIgNwZA2629wepmhW2PTb06JZALwEeZBa6Mmkat1oFV9o5n1T8fMLQ8ZArc8geYfcjWhJdCkfNv86GAsknRyjNYJOamk8nZAL8vV3SSt8w1oxjZC6xoafn2P2U3xVMrJErgNpu9s1M3ZAZAvMhTd9ybZBOrFyZAEZD").runEverything();
  }
...
//    rawJsonResponse();
  ...
  com.restfb.types.User user = jsonMapper.toJavaObject(results.getString("btaylor"), User.class);
  ...
  void search() {
    ...
    Connection<Post> publicSearch =
        facebookClient.fetchConnection("search", Post.class, Parameter.with("q", "abdouli"),
          Parameter.with("type", "post"));

    Connection<User> targetedSearch =
        facebookClient.fetchConnection("me/home", User.class, Parameter.with("q", "chaima"),
